...
# Print dataset
print("=== Day116 Dataset with Percentiles ===")
print(df)
...
plt.title("Day116 — Exam Grades with Percentiles")
plt.xlabel("Subject")
plt.ylabel("Grade")
...
# Export to CSV
df.to_csv("Day116_SQL_Advanced_Window_Functions_Integrated_Percentile_Summary.csv", index=False)
