...
data = {
    "subject": ["Math", "Science", "English", "History", "PE"],
    "grade": [95, 92, 88, 85, 90]
}
...
# Print dataset
print("=== Day119 Dataset with Percentiles ===")
print(df)
...
plt.title("Day119 — Multi-Subject Grades vs Percentile Comparison")
plt.xlabel("Subject")
plt.ylabel("Value")
plt.legend()
...
# Export to CSV
df.to_csv("Day119_SQL_Window_Functions_Multi_Dataset_Percentile_Comparison.csv", index=False)
