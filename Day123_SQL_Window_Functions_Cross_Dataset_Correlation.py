...
plt.title("Day123 — Dataset A vs Dataset B Correlation Trends")
plt.xlabel("Subject")
plt.ylabel("Value")
plt.legend()
plt.show()
...
# Export Dataset A
df_a.to_csv("Day123_Dataset_A_Correlation.csv", index=False)

# Export Dataset B
df_b.to_csv("Day123_Dataset_B_Correlation.csv", index=False)
